                    ...
                    (a = {
                        ...
                        B: function () {
                            var e = 3600 * n.getUTCHours(),
                                ...
                                a = n.getUTCSeconds();
                            return s(
                                Math.floor((e + t + a + 3600) / 86.4) % 1e3,
                                3
                            );
                        },
                        g: function () {
    ...
    var s = {
        ...
        r = function () {
            ...
            "function" == typeof DateFormatter &&
                (E = n =
                    new DateFormatter({ dateSettings: L.extend({}, a, t) }));
        },
        o = {
            moment: {
                default_options: {
                ...
                "hide" !== y
                    ? (L(this).hasClass("xdsoft_scroller_box") ||
                          ...
                          (p = function (e) {
                              var t = a(e).y - r + g;
                              t < 0 && (t = 0),
                                  t + u[0].offsetHeight > h &&
                                      (t = h - u[0].offsetHeight),
                    ...
                    F.find(".xdsoft_select")
                        ...
                        (_.setOptions = function (e) {
                            ...
                            (I = L.extend(!0, {}, I, e)),
                                ...
                                I.value &&
                                    (W.setCurrentTime(I.value),
                                    O && O.val && O.val(W.str)),
                                isNaN(I.dayOfWeekStart)
                                    ? (I.dayOfWeekStart = 0)
                                    : (I.dayOfWeekStart =
                                          parseInt(I.dayOfWeekStart, 10) % 7),
                                I.timepickerScrollbar ||
                                    u.xdsoftScroller(I, "hide"),
                                I.minDate &&
                                    /^[\+\-](.*)$/.test(I.minDate) &&
                                ...
                                I.minDateTime &&
                                    /^\+(.*)$/.test(I.minDateTime) &&
                                    (I.minDateTime = W.strToDateTime(
                                        I.minDateTime
                                    ).dateFormat(I.formatDate)),
                                I.maxDateTime &&
                                    /^\+(.*)$/.test(I.maxDateTime) &&
                                    (I.maxDateTime = W.strToDateTime(
                                        I.maxDateTime
                                    ).dateFormat(I.formatDate)),
                                ...
                                (I.dayOfWeekStartPrev =
                                    0 === I.dayOfWeekStart
                                        ? 6
                                        : I.dayOfWeekStart - 1),
                                _.trigger("xchange.xdsoft").trigger(
                                    "afterOpen.xdsoft"
                                );
                        }),
                        _.data("options", I).on(
                        ...
                        (W = new (function () {
                            ...
                            (r.now = function (e) {
                                ...
                                (r.getWeekOfYear = function (e) {
                                    if (
                                        I.onGetWeekOfYear &&
                                        L.isFunction(I.onGetWeekOfYear)
                                    ) {
                                ...
                                (r.strToDate = function (e) {
                                    if (
                                        ...
                                        return e;
                                    var t = e
                                        ? E.parseDate(e, I.formatDate)
                                        : r.now(!0);
                                    return (
                                        r.isValidDate(t) || (t = r.now(!0)), t
                                    );
                                }),
                            ...
                            clearTimeout(t),
                                (t = setTimeout(function () {
                                    ...
                                    for (
                                        ...
                                        l +=
                                            "<th>" +
                                            I.i18n[R].dayOfWeekShort[
                                                (e + I.dayOfWeekStart) % 7
                                            ] +
                                            "</th>";
                                    for (
                                        l += "</tr></thead>",
                        ...
                        g.on("mousewheel.xdsoft", function (e) {
                            return (
                                !I.scrollMonth ||
                                (e.deltaY < 0 ? W.nextMonth() : W.prevMonth(),
                                !1)
                            );
                        }),
                        ...
                        _.on("changedatetime.xdsoft", function (e) {
                            if (
                                I.onChangeDateTime &&
                                L.isFunction(I.onChangeDateTime)
                            ) {
                                var t = _.data("input");
                        ...
                        (r = function () {
                            ...
                            if (
                                ...
                                I.ownerDocument.documentElement.clientWidth -
                                    e.left <
                                    g.parent().outerWidth(!0))
                            ) {
                                var m =
                                    g.parent().outerWidth(!0) - t.offsetWidth;
                                n -= m;
                            }
                        ...
                        O.data("xdsoft_datetimepicker", _)
                            .on(
                                ...
                                function () {
                                    O.is(":disabled") ||
                                        (O.data("xdsoft_datetimepicker").is(
                                            ":visible"
                                        ) &&
                                            I.closeOnInputClick) ||
                                        (I.openOnFocus &&
