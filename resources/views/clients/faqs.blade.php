                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="image mb-30">
                                    <img class="br-10 w-100" src="{{ asset('clients/images/destinations/faq1.jpg')}}" alt="FAQ">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="image mb-30">
                                    <img class="br-10 w-100" src="{{ asset('clients/images/destinations/faq2.jpg')}}" alt="FAQ">
                                </div>
                                <div class="image mb-30">
                                    <img class="br-10 w-100" src="{{ asset('clients/images/destinations/faq3.jpg')}}" alt="FAQ">
                                </div>
                            </div>
                        </div>
                    </div>
