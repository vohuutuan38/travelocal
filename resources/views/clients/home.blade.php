                    ...
                    <form method="post" action="https://webtendtheme.net/html/2024/ravelo/contact.html">
                        ...
                        <div class="form-group">
                            <button type="submit" class="theme-btn style-two">
                                <span data-hover="Submit now">Đăng ký ngay</span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <h2>Khám phá kho báu thế giới cùng Traveloka</h2>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="divider counter-text-wrap mt-45 mb-55"><span>Chúng tôi có <span><span class="count-text plus" data-speed="3000" data-stop="25">5</span> năm</span>kinh nghiệm</span></div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                        <div class="about-us-image">
                            <div class="shape"><img src="{{ asset('clients/images/about/shape1.png')}}" alt="Shape"></div>
                            <div class="shape"><img src="{{ asset('clients/images/about/shape2.png')}}" alt="Shape"></div>
                            <div class="shape"><img src="{{ asset('clients/images/about/shape3.png')}}" alt="Shape"></div>
                            <div class="shape"><img src="{{ asset('clients/images/about/shape4.png')}}" alt="Shape"></div>
                            <div class="shape"><img src="{{ asset('clients/images/about/shape5.png')}}" alt="Shape"></div>
                            <div class="shape"><img src="{{ asset('clients/images/about/shape6.png')}}" alt="Shape"></div>
                            <div class="shape"><img src="{{ asset('clients/images/about/shape7.png')}}" alt="Shape"></div>
                            <img src="{{ asset('clients/images/about/about.png')}}" alt="About">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-duration="1500" data-aos-offset="50">
                                    ...
                                    <div class="content">
                                        <h6><a href="destination-details.html">Khu bảo tồn của Canada, Canada</a></h6>
                                        <span class="time">5352+ tours & 856+ Hoạt động</span>
                                        <a href="#" class="more"><i class="fas fa-chevron-right"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="features-content-part mb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="features-customer-box">
                                <div class="image">
                                    <img src="{{ asset('clients/images/features/features-box.jpg')}}" alt="Features">
                                </div>
                                <div class="content">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Câu cá và chèo thuyền mang lại niềm vui là những hoạt động tinh túy</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="mobile-app-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            <div class="section-title mb-30">
                                <h2>Chúng tôi có sẵn trên cửa hàng. Tải ứng dụng di động của chúng tôi rất dễ dàng.</h2>
                            </div>
                            <p>Chúng tôi luôn nỗ lực hết mình để biến giấc mơ du lịch của bạn thành hiện thực. Hãy tin tưởng chúng tôi sẽ lo liệu mọi chi tiết để bạn có thể tạo nên những kỷ niệm khó quên. Khám phá thế giới một cách tự tin.</p>
                            ...
                            <div class="google-play-app-store">
                                <a href="#"><img src="{{ asset('clients/images/mobile-app/g-play.jpg')}}" alt="Google Play"></a>
                                <a href="#"><img src="{{ asset('clients/images/mobile-app/a-store.jpg')}}" alt="App Store"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="mobile-app-images">
                            <div class="bg"><img src="{{ asset('clients/images/mobile-app/phone-bg.png')}}" alt="BG"></div>
                            <div class="images">
                                <img src="{{ asset('clients/images/mobile-app/phone2.png')}}" alt="Phone" data-aos="fade-down-left" data-aos-duration="1500" data-aos-offset="50">
                                <img src="{{ asset('clients/images/mobile-app/phone.png')}}" alt="Phone">
                                <img src="{{ asset('clients/images/mobile-app/phone3.png')}}" alt="Phone" data-aos="fade-up-right" data-aos-duration="1500" data-aos-offset="50">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonials-wrap bgc-lighter">
                    <div class="row">
                        <div class="col-lg-5 rel" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                            <div class="testimonial-left-image rmb-55" style="background-image: url({{ asset('clients/images/testimonials/testimonial-left.jpg')}});"></div>
                        </div>
                        <div class="col-lg-7">
                            <div class="testimonial-right-content" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="testimonials-active">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="text">"Chuyến đi của chúng tôi thật sự hoàn hảo, cảm ơn công ty du lịch này! Họ đã chăm chút từng chi tiết, từ chỗ ở đến cả những gợi ý trải nghiệm tuyệt vời."</div>
                                        <div class="author">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-title text-center counter-text-wrap mb-70" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <p>Một trang web <span class="count-text plus bgc-primary" data-speed="3000" data-stop="34500">0</span> trải nghiệm phổ biến nhất mà bạn sẽ nhớ</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="{{ asset('clients/images/blog/blog1.jpg')}}" alt="Blog">
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="{{ asset('clients/images/blog/blog2.jpg')}}" alt="Blog">
                            </div>
                            <a href="blog-details.html" class="theme-btn">
                                <span data-hover="Book Now">Read More</span>
                                <i class="fal fa-arrow-right"></i>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="{{ asset('clients/images/blog/blog3.jpg')}}" alt="Blog">
                            </div>
                            <a href="blog-details.html" class="theme-btn">
                                <span data-hover="Book Now">Read More</span>
                                <i class="fal fa-arrow-right"></i>
