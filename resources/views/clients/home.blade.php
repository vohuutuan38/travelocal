                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="content">
                                ...
                                <h5 class="text-tour-home"><a
                                        href="{{ route('tour-detail', $tour->tourId) }}">{{ $tour->title }}</a></h5>
                                <span class="time">{{ $tour->time }}</span>
                            </div>
                            <div class="destination-footer">
                                <span class="price"><span>{{ number_format($tour->priceAdult) }}</span> VND / Người</span>
                                <a href="{{ route('tour-detail', $tour->tourId) }}" class="read-more">Book Now <i
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-6">
                    <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <p>Chúng tôi sẽ nỗ lực hết mình để biến giấc mơ du lịch của bạn thành hiện thực, khám phá những viên
                        ...
                        <div class="divider counter-text-wrap mt-45 mb-55"><span>Chúng tôi có <span><span
                                        class="count-text plus" data-speed="3000" data-stop="25">5</span> năm</span>kinh
                                nghiệm</span></div>
                        <div class="row">
                            <div class="col-6">
                        ...
                        @forelse ($popularDestinations as $destination)
                            <div class="col-xl-3 col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-duration="1500">
                                    <div class="image">
                                        {{-- Dùng cột thumbnail có sẵn trong model City --}}
                                        <img src="{{ asset('clients/images/city/'.$destination->thumbnail) }}" alt="{{ $destination->name }}">
                                    </div>
                                    
                                    <div class="content">
                                        <h6><a href="#">{{ $destination->name }}</a></h6>
                                        {{-- Dùng tours_count và bookings_count đã được tạo tự động --}}
                                        <span class="time">{{ $destination->tours_count }}+  tours &
                                            {{ $destination->bookings_count }}+  lượt đặt</span>
                                        <a href="#" class="more"><i class="fas fa-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        @empty
                            <p class="text-center">Chưa có điểm đến phổ biến nào để hiển thị.</p>
                        @endforelse
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="mobile-app-content rmb-55" data-aos="fade-left" data-aos-duration="1500"
                        ...
                        <p>Chúng tôi luôn nỗ lực hết mình để biến giấc mơ du lịch của bạn thành hiện thực. Hãy tin tưởng
                            chúng tôi sẽ lo liệu mọi chi tiết để bạn có thể tạo nên những kỷ niệm khó quên. Khám phá thế
                            giới một cách tự tin.</p>
                        ...
                        <div class="google-play-app-store">
                            <a href="#"><img src="{{ asset('clients/images/mobile-app/g-play.jpg') }}"
                                    alt="Google Play"></a>
                            <a href="#"><img src="{{ asset('clients/images/mobile-app/a-store.jpg') }}"
                                    alt="App Store"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mobile-app-images">
                        <div class="bg"><img src="{{ asset('clients/images/mobile-app/phone-bg.png') }}"
                                alt="BG"></div>
                        <div class="images">
                            <img src="{{ asset('clients/images/mobile-app/phone2.png') }}" alt="Phone"
                            ...
                            <img src="{{ asset('clients/images/mobile-app/phone3.png') }}" alt="Phone"
                ...
                <div class="row">
                    <div class="col-lg-5 rel" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                        <div class="testimonial-left-image rmb-55"
                            style="background-image: url({{ asset('clients/images/testimonials/testimonial-left.jpg') }});">
                        </div>
                    </div>
                    <div class="col-lg-7">
                            ...
                            <div class="testimonials-active">
                                <div class="testimonial-item">
                                    ...
                                    <div class="text">"Chuyến đi của chúng tôi thật sự hoàn hảo, cảm ơn công ty du lịch
                                        này! Họ đã chăm chút từng chi tiết, từ chỗ ở đến cả những gợi ý trải nghiệm tuyệt
                                        vời."</div>
                                    <div class="author">
                                        <div class="image"><img
                                                src="{{ asset('clients/images/testimonials/author.jpg') }}"
                                                alt="Author"></div>
                                        <div class="content">
