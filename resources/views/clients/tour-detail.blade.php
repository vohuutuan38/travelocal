                    ...
                    <div class="col-lg-12">
                       <div class="gallery-more-btn">
                            <a href="contact.html" class="theme-btn style-two bgc-secondary">
                                <span data-hover="Xem tất cả ảnh">Xem tất cả ảnh</span>
                        ...
                        <div class="blog-sidebar tour-sidebar">
                            ...
                            <div class="widget widget-booking" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <form action="#">
                                    ...
                                    <ul class="tickets clearfix">
                                        <li>
                                            Người lớn (dưới 18 tuổi) <span class="price">$28.50</span>
                                        ...
                                        <li>
                                            Người lớn (18+ tuổi) <span class="price">$50.40</span>
                                            <select name="18+" id="18+">
                                                <option value="value1">01</option>
                                                <option value="value1">02</option>
                                    ...
                                    <ul class="radio-filter pt-5">
                                        <li>
                                            ...
                                            <label for="add-extra1">Thêm dịch vụ cho mỗi lượt đặt chỗ <span>$50</span></label>
                                        </li>
                                        <li>
                                            <input class="form-check-input" type="radio" name="AddExtra" id="add-extra2">
                                            <label for="add-extra2">Thêm dịch vụ cho mỗi cá nhân <span>$24</span></label>
                                        </li>
                                    </ul>
                                    <hr>
                            ...
                            <div class="widget widget-contact" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <ul class="list-style-one">
                                    <li><i class="far fa-envelope"></i> <a href="emilto:vohuutuan04@gmail.com">vohuutuan04@gmail.com</a></li>
                                    <li><i class="far fa-phone-volume"></i> <a href="callto: 0799123089">+84 0799123089</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="widget widget-cta" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="cta-shape"><img src="{{ asset('clients/images/widgets/cta-shape3.png')}}" alt="Shape"></div>
                            </div>
