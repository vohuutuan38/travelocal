            ...
            <div class="col-lg-8">
                <div class="blog-details-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <ul class="blog-meta mb-30">
                        <li><img src="{{ asset('clients/images/blog/admin.jpg')}}" alt="Admin"> <a href="#">Reed A. Johnson</a></li>
                    ...
                    <div class="image mt-40 mb-30" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <img src="{{ asset('clients/images/blog/blog-details.jpg')}}" alt="Blog Details">
                    </div>
                    ...
                    <div class="row mb-10">
                        <div class="col-sm-6">
                            <div class="image mb-30" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                <img src="{{ asset('clients/images/blog/blog-middle1.jpg')}}" alt="Blog">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="image mb-30" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="50">
                                <img src="{{ asset('clients/images/blog/blog-middle2.jpg')}}" alt="Blog">
                            </div>
                        </div>
                    </div>
                ...
                <div class="admin-comment bgc-lighter" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="comment-body">
                        <div class="author-thumb">
                            <img src="{{ asset('clients/images/blog/admin-comment.jpg')}}" alt="Author">
                        </div>
                        <div class="content">
                ...
                <div class="next-prev-blog pt-70 pb-15">
                    <div class="item" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <img src="{{ asset('clients/images/blog/prev-post.jpg')}}" alt="News">
                        </div>
                        <div class="content">
                    ...
                    <div class="item" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <img src="{{ asset('clients/images/blog/next-post.jpg')}}" alt="News">
                        </div>
                        <div class="content">
                ...
                <div class="blog-sidebar">
                    ...
                    <div class="widget widget-news" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <ul>
                            <li>
                                <div class="image">
                                    <img src="{{ asset('clients/images/widgets/news1.jpg')}}" alt="News">
                                </div>
                                <div class="content">
                                    <h6><a href="blog-details.html">Unique Destinations an tolded Stories ways</a></h6>
                                    <span class="date"><i class="far fa-calendar-alt"></i> 25 Feb 2024</span>
                            ...
                            <li>
                                <div class="image">
                                    <img src="{{ asset('clients/images/widgets/news2.jpg')}}" alt="News">
                                </div>
                                <div class="content">
                                    <h6><a href="blog-details.html">Immersive Experiences from Around Globe</a></h6>
                                    <span class="date"><i class="far fa-calendar-alt"></i> 25 Feb 2024</span>
                            ...
                            <li>
                                <div class="image">
                                    <img src="{{ asset('clients/images/widgets/news3.jpg')}}" alt="News">
                                </div>
                                <div class="content">
                    ...
                    <div class="widget widget-gallery" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <div class="gallery">
                            <a href="{{ asset('clients/images/widgets/gallery1.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery1.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery2.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery2.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery3.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery3.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery4.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery4.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery5.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery5.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery6.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery6.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery7.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery7.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery8.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery8.jpg')}}" alt="Gallery">
                            </a>
                            <a href="{{ asset('clients/images/widgets/gallery9.jpg')}}">
                                <img src="{{ asset('clients/images/widgets/gallery9.jpg')}}" alt="Gallery">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="widget widget-cta" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <div class="cta-shape"><img src="{{ asset('clients/images/widgets/cta-shape.png')}}" alt="Shape"></div>
                    </div>
